...
def get_chain(vectorstore: VectorStore,prompt: PromptTemplate) -> ChatVectorDBChain:
    ...
    llmHugging = HuggingFaceHub(repo_id="google/flan-t5-xl", model_kwargs={"temperature":0, "max_length":128})
    ...
    qa = ConversationalRetrievalChain.from_llm(llmHugging, vectorstore.as_retriever(), return_source_documents=True)
    return qa